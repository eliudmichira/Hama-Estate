...
function ModernRegister() {
  ...
  const auth = useAuth();
  const { signUp, signInWithGoogleAuth } = auth || {};
    ...
    <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="bg-white/90 backdrop-blur-2xl rounded-2xl p-2 shadow-2xl border border-white/50">
          <div className="flex gap-1">
            <button
              ...
              className="relative px-6 py-3 rounded-xl font-bold text-sm transition-all duration-300 bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg transform scale-105"
            >
              Sign In
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-100">
        ...
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-0 -left-40 w-96 h-96 bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob"></div>
          <div className="absolute top-0 -right-40 w-96 h-96 bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-2000"></div>
          <div className="absolute -bottom-40 left-20 w-96 h-96 bg-gradient-to-r from-teal-400 via-emerald-400 to-green-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000"></div>
          <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-6000"></div>
        </div>
          ...
          <div className="flex items-center justify-center gap-16 lg:gap-24">
            ...
            <div className="hidden lg:flex flex-col space-y-8 flex-1 max-w-lg">
              ...
              <div className="space-y-6 animate-fade-in-up">
                ...
                <p className="text-gray-600 text-lg leading-relaxed max-w-md">
                  Create your account and discover a new way to explore, manage, and invest in real estate opportunities worldwide.
                </p>
              </div>
              ...
              <div className="space-y-4 animate-fade-in-up-delay">
                ...
                <FeatureCard 
                  ...
                  description="Access to exclusive listings and comprehensive market analytics"
                  gradient="from-cyan-500 to-blue-500"
                />
                <FeatureCard 
                  icon={Star}
                  title="Expert Support"
                  description="24/7 support from our real estate professionals and advisors"
            ...
            <div className="w-full max-w-md lg:max-w-lg">
              ...
              <div className="text-center mb-8 animate-fade-in">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-emerald-600 via-teal-600 to-cyan-700 rounded-3xl mb-6 shadow-2xl relative group">
                  ...
                  <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-emerald-400/0 to-teal-400/20 group-hover:from-emerald-400/20 group-hover:to-teal-400/40 transition-all duration-300"></div>
                </div>
                <h2 className="text-3xl font-bold text-gray-800 mb-2">Create Account</h2>
                <p className="text-gray-600 text-lg">Join our real estate community</p>
              </div>
              ...
              <div className="backdrop-blur-2xl bg-white/70 border border-white/50 shadow-2xl rounded-3xl p-8 lg:p-10 animate-slide-up">
                  ...
                  <div className="pt-2">
                    <label className="flex items-start gap-3 cursor-pointer group">
                      <input 
                        ...
                        className="w-5 h-5 text-emerald-600 border-2 border-gray-300 rounded-md focus:ring-emerald-500 focus:ring-2 mt-0.5 transition-all duration-200" 
                        disabled={isSubmitting}
                      />
                      <span className="text-sm text-gray-700 leading-relaxed group-hover:text-gray-900 transition-colors">
                        I agree to the{' '}
                        <button type="button" className="text-emerald-600 hover:text-emerald-700 font-bold hover:underline transition-colors" onClick={handleTermsClick}>
                          Terms of Service
                        </button>{' '}
                        and{' '}
                        <button type="button" className="text-emerald-600 hover:text-emerald-700 font-bold hover:underline transition-colors" onClick={handlePrivacyClick}>
                          Privacy Policy
                        </button>
                      </span>
                    </label>
                ...
                <div className="text-center mt-8 pt-6 border-t border-gray-200/50">
                  ...
                  <button
                    onClick={() => navigate('/login')}
                    className="text-emerald-600 hover:text-emerald-700 font-bold text-sm hover:underline transition-colors disabled:opacity-50"
